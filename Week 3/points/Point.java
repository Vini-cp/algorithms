...
public class Point implements Comparable<Point> {
    ...
    public Comparator<Point> slopeOrder() {
        ...
        return new Comparator<Point>() {
            public int compare(Point p1, Point p2) {
                return Double.compare(p1.slopeTo(that), p2.slopeTo(that));
            }
        };
    }
    ...
    public static void main(String[] args) {
        Point p = new Point(23305, 23739);
        Point q = new Point(23305, 27785);
        Point r = new Point(11102, 28358);
        
        Comparator<Point> comp = p.slopeOrder();
        StdOut.println(comp.compare(q, r));
